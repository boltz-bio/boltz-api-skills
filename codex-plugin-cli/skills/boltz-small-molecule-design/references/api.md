...
Covers the `small-molecule:design` endpoint. The payload becomes the body passed via `--input @yaml://payload.yaml`. Field names below are **API body field names**, not CLI flag names.
