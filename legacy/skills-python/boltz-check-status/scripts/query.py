...
--id <job_id> --download: re-downloads artifacts into ./boltz_outputs/<id>/ if
not already present.
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--download", action="store_true", help="With --id: re-download artifacts into ./boltz_outputs/<id>/ if not present.")
...
def main() -> int:
    ...
    if args.id:
        ...
        if args.download:
            out_dir = Path(args.output_dir).expanduser() / args.id
