...
- Cost is a flat $0.025 per molecule (size-independent). `estimate-cost` returns the authoritative total — always use it. Submit without asking only when `estimated_cost_usd` is less than $1.00; require explicit confirmation for $1.00 or more.
